...
int Queue_IsEmpty( const Queue *queue ) {
    ...
    // ak sa prvy a posledny index rovnaju vrati sa 1 inak nula 
...
int Queue_IsFull( const Queue *queue ) {
    // ak je prvy index o 1 vacsi ako posledny zanamena to ze je queue prazdna a vrati sa 1 
